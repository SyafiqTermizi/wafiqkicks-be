...
LOCAL_APPS = [
    "preggy.kicks.apps.KicksConfig",
    "preggy.users.apps.UsersConfig",
]
...
ROOT_URLCONF = "preggy.config.urls"
...
WSGI_APPLICATION = "preggy.config.wsgi.application"
...
AUTHENTICATION_BACKENDS = [
    ...
    "preggy.users.backends.EmailBackend",
]
